package cn.com.ut.cache.config;
...
import cn.com.ut.cache.CacheTime;
import cn.com.ut.cache.CustomizedRedisCacheManager;
...
public class RedisConfig {
	...
	public RedisTemplate<String, Object> redisTemplate(
		...
		// 建议使用这种方式，小范围指定白名单
		ParserConfig.getGlobalInstance().addAccept("cn.com.ut.");
	...
	public RedisCacheManager cacheManager(RedisTemplate<String, Object> redisTemplate) {
		...
		cacheTimes.put("goods", new CacheTime(selectCacheRefresh, selectCacheTimeout));
