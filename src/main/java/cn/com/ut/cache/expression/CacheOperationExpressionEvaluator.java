...
/**
 * Utility class handling the SpEL expression parsing. Meant to be used as a
 * reusable, thread-safe component.
 *
 * <p>
 * Performs internal caching for performance reasons using
 * {@link AnnotatedElementKey}.
 *
 * @author Costin Leau
 * @author Phillip Webb
 * @author Sam Brannen
...
public class CacheOperationExpressionEvaluator extends CachedExpressionEvaluator {
	 ...
	 *            the target class
	 * @param result
	 *            the return value (can be {@code null}) or {@link #NO_RESULT}
	 *            if there is no return at this time
