 ...
 * variables, in a lazy manner. The lazy nature eliminates unneeded parsing of
 * classes byte code for parameter discovery.
 *
 * <p>
 * Also define a set of "unavailable variables" (i.e. variables that should lead
 * to an exception right the way when they are accessed). This can be useful to
 * verify a condition does not match even when not all potential variables are
 * present.
 *
 * <p>
...
class CacheEvaluationContext extends MethodBasedEvaluationContext {
	 ...
	 * expression trying to access this variable should lead to an exception.
	 * <p>
